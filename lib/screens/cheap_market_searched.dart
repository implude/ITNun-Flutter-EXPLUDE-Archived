                  ...
                  Container(
                    child: Column(
                      children: [
                        ...
                        CheapMarketSearchAppBox(title: "헤어디자이너 수빈", category: "이미용업", local: "광주광역시", ismarked:false),CheapMarketSearchAppBox(title: "체스보드게임", category: "기타서비스업", local: "부산광역시", ismarked: true),
                        CheapMarketSearchAppBox(title: "맥스리뷰(금정점)", category: "기타서비스업", local: "부산광역시", ismarked: false),
                        CheapMarketSearchAppBox(title: "펠로", category: "양식", local: "부산광역시", ismarked: false),
                        CheapMarketSearchAppBox(title: "헤어디자이너 수빈", category: "이미용업", local: "광주광역시", ismarked:false),CheapMarketSearchAppBox(title: "체스보드게임", category: "기타서비스업", local: "부산광역시", ismarked: true),
                        CheapMarketSearchAppBox(title: "맥스리뷰(금정점)", category: "기타서비스업", local: "부산광역시", ismarked: false),
